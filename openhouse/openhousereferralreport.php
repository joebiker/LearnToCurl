...
<title>Learn to Curl Referral Report</title>
</HEAD>
<BODY>
...
$result = mysql_query("select DATE_FORMAT(create_date,'%d-%b-%y'),confirmation, group_adults, group_juniors,user_refer,reg_refer from openhouse where User_refer is not null and User_refer > '' order by create_date desc limit 100;", $db_conn);
if($result) { //query was a success
	echo "<table>\n<TR><TH>Registered</TH><TH>A</TH><TH>J</TH><TH>Comment referral</TH><TH>URL used to link to registration</TH></TR>";
